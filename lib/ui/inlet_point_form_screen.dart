...
/// Add or edit a single inlet point. Apartment (BHK), sensor (a Group A
/// material reference), qty, and series are mandatory (see `_save`); every
/// other field is optional (partial saves).
...
class _InletPointFormScreenState extends State<InletPointFormScreen> {
  ...
  /// getters). Resolved from [InletPoint.materialId] once [_groupAMaterials]
